...
Процедура ВыполнитьФоновоеЗаданиеВнешнейОбработки(структураПараметровВызова) Экспорт
	
	
	ссылкаНаОбъект = Справочники.ДополнительныеОтчетыИОбработки.НайтиПоНаименованию(структураПараметровВызова.НаименованиеОбработки);
	
	имяФайла = ПолучитьИмяВременногоФайла();
	двоичныеДанные = ссылкаНаОбъект.ХранилищеОбработки.Получить();
	двоичныеДанные.Записать(ИмяФайла);	// Вставить содержимое обработчика.
	
	Обработка = ВнешниеОбработки.Создать(ИмяФайла);
	ЗначениеИзОбработки = Обработка.ФункцияМодуляОбъекта(структураПараметровВызова);
