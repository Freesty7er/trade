...
Процедура КомандаРасчитатьНаСервере()
	...
	|	ПОДСТРОКА(Планирование_ЛистЗадачСостав.Задача, 1, 150) КАК Задача,
	|	СРЕДНЕЕ(Планирование_ЛистЗадачСостав.План) КАК План
	|ПОМЕСТИТЬ ВТ_Планирование
	|ИЗ
	|	Документ.Планирование_ЛистЗадач.Состав КАК Планирование_ЛистЗадачСостав
	|ГДЕ
	|	Планирование_ЛистЗадачСостав.Ссылка = &СсылкаПланирование
	|
	|СГРУППИРОВАТЬ ПО
	|	Планирование_ЛистЗадачСостав.Менеджер,
	|	ПОДСТРОКА(Планирование_ЛистЗадачСостав.Задача, 1, 150)
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	Менеджер,
	|	Задача
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	Планирование_ВыполнениеЛистаЗадачБазыРасчетаЗарплаты.Менеджер КАК Менеджер,
	|	Планирование_ВыполнениеЛистаЗадачБазыРасчетаЗарплаты.Сотрудник,
	|	Планирование_ВыполнениеЛистаЗадачБазыРасчетаЗарплаты.БазаРасчета,
	|	Планирование_ВыполнениеЛистаЗадачБазыРасчетаЗарплаты.Ссылка.Подразделение,
	|	Планирование_ВыполнениеЛистаЗадачБазыРасчетаЗарплаты.Ссылка.ПоказательКПИ
	|ПОМЕСТИТЬ ВТ_БазыРасчетаЗарплаты
	|ИЗ
	|	Документ.Планирование_ВыполнениеЛистаЗадач.БазыРасчетаЗарплаты КАК Планирование_ВыполнениеЛистаЗадачБазыРасчетаЗарплаты
	|ГДЕ
	|	Планирование_ВыполнениеЛистаЗадачБазыРасчетаЗарплаты.Ссылка = &Ссылка
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	Менеджер
	|;
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	Планирование_ВыполнениеЛистаЗадачИсходныеДанные.Менеджер КАК Менеджер,
	|	ПОДСТРОКА(Планирование_ВыполнениеЛистаЗадачИсходныеДанные.Задача, 1, 150) КАК Задача,
	|	СРЕДНЕЕ(Планирование_ВыполнениеЛистаЗадачИсходныеДанные.Факт) КАК Показатель
	|ПОМЕСТИТЬ ВТ_СгруппированныеИсходныеДанные
	|ИЗ
	|	Документ.Планирование_ВыполнениеЛистаЗадач.ИсходныеДанные КАК Планирование_ВыполнениеЛистаЗадачИсходныеДанные
	|ГДЕ
	|	Планирование_ВыполнениеЛистаЗадачИсходныеДанные.Ссылка = &Ссылка
	|
	|СГРУППИРОВАТЬ ПО
	|	Планирование_ВыполнениеЛистаЗадачИсходныеДанные.Менеджер,
	|	ПОДСТРОКА(Планирование_ВыполнениеЛистаЗадачИсходныеДанные.Задача, 1, 150)
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	Менеджер,
	|	Задача
	...
	|	ВТ_СгруппированныеИсходныеДанные.Задача,
	...
	|			И ВТ_СгруппированныеИсходныеДанные.Задача = ВТ_Планирование.Задача
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВТ_Выполнение.Менеджер,
	|	ВТ_Выполнение.Задача,
	|	ВТ_Выполнение.Показатель,
	|	ВТ_Выполнение.Выполнение,
	|	ВЫБОР
	|		КОГДА ВТ_Выполнение.Выполнение > 120
	|			ТОГДА 1.2
	|		ИНАЧЕ ВТ_Выполнение.Выполнение / 100
	...
	|	ВТ_БазыРасчетаЗарплаты.БазаРасчета * ВТ_АнализВыполнения.ЗначениеОценки КАК Результат
	|ИЗ
