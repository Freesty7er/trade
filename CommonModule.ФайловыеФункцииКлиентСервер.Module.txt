...
//	Исключение
//		ТекстОшибки = ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()) + """" + ПолноеИмяФайла + """";
//		#Если НаКлиенте Тогда
//			ОбщегоНазначенияКлиент.ДобавитьСообщениеДляЖурналаРегистрации("Извлечение текста",
...
#КонецЕсли
		...
		Иначе
			...
			ОбщегоНазначенияКлиентСервер.ДобавитьСлешЕслиНужно(ПодКаталог, ТипПлатформыТекущий);  
		КонецЕсли;
