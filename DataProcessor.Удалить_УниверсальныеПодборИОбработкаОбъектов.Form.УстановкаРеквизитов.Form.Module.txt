...
Процедура УстановитьКартинкуСтраниц()
	...
	Если НайденныеСтроки.Количество() > 0 Тогда
		...
		КонецЕсли; 
		Элементы.ГруппаСтраницаРеквизиты.Заголовок = Заголовок + " (" + XMLСтрока(НайденныеСтроки.Количество()) + ")";
	Иначе
		Элементы.ГруппаСтраницаРеквизиты.Картинка = Новый Картинка;
		Элементы.ГруппаСтраницаРеквизиты.Заголовок = Заголовок;
	КонецЕсли; 
	
	НайденныеСтроки = РеквизитыТаблицы.НайтиСтроки(СтруктураОтбора);
	Заголовок = "Реквизиты табличной части";
	Если НайденныеСтроки.Количество() > 0 Тогда
		Если Элементы.ГруппаСтраницыРеквизитыТабличнойЧасти.Картинка <> ВидКартинки.Пустая Тогда
			Элементы.ГруппаСтраницыРеквизитыТабличнойЧасти.Картинка = БиблиотекаКартинок.ЗаписатьИЗакрыть;
		КонецЕсли; 
		Элементы.ГруппаСтраницыРеквизитыТабличнойЧасти.Заголовок = Заголовок + " (" + XMLСтрока(НайденныеСтроки.Количество()) + ")";
	Иначе
		Элементы.ГруппаСтраницыРеквизитыТабличнойЧасти.Картинка = Новый Картинка;
		Элементы.ГруппаСтраницыРеквизитыТабличнойЧасти.Заголовок = Заголовок;
	КонецЕсли; 
...
мНастройка = Новый Структура("РеквизитыДляСохранения, РеквизитыТаблицыДляСохранения, СписокТабличнаяЧасть");

//мНастройка.<Имя реквизита> = <Значение реквизита>;

мТипыОбрабатываемыхОбъектов = "Справочник,Документ,Задача,БизнесПроцесс,ПланВидовХарактеристик,ПланВидовРасчета,ПланОбмена";