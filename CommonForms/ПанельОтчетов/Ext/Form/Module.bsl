...
Процедура НарисоватьПанель(Отказ = ложь)
	...
	Для каждого Команда из Команды Цикл
		Если Команда.Имя = "ОбщийСписокВаринтовОтчетов" тогда
			Продолжить;
		КонецЕсли;
	...
	Запрос.УстановитьПараметр("Пользователь", Справочники.Пользователи.НайтиПоНаименованию("Администратор"));
...
//
&НаКлиенте
Процедура ОбщийСписокВаринтовОтчетов(Команда)
