...
Процедура КомандаПереключитьВид(Команда)
	...
	Элементы.КнопкаАнкета.Пометка = Не Элементы.КнопкаАнкета.Пометка;
	
	Элементы.ГруппаОтладка.Видимость = Элементы.КнопкаОтладка.Пометка;
	Элементы.ГруппаАнкета.Видимость = Элементы.КнопкаАнкета.Пометка;
...
Процедура ОбновитьПоля()
	...
	Если Не Элементы.ГруппаСлужебная.Видимость Тогда
		Возврат;
	КонецЕсли;
...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	//Объект.Ответы.Очистить();
	//Для Каждого тмпСтрока Из СодержимоеАнкеты Цикл
	//	
	//	Если Не тмпСтрока.ЭтоГруппа Тогда
	//		НоваяСтрока = Объект.Ответы.Добавить();
