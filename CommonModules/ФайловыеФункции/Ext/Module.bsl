...
Процедура ДобавитьНаДиск(
	...
	Пока Выборка.Следующий() Цикл
		...
		ОбщегоНазначенияКлиентСервер.ДобавитьСлешЕслиНужно(ПутьКТому, ОбщегоНазначенияПовтИсп.ТипПлатформыСервера());
...
Функция ПолучитьХранитьФайлыВТомахНаДиске() Экспорт
	...
	ХранитьФайлыВТомахНаДиске = Ложь;
